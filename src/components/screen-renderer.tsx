...
import { ActivityPanel,ApprovalQueue,DataTable,DeliveryProof,FilterBar,FormShell,KitBuilder,KpiGrid,PageHeader,Planner,StateGallery,StatusBadge } from "@/components/ui";
...
export function ScreenRenderer({screen}:{screen:ScreenDefinition}){
  ...
  const isForm=screen.kind==="form"&&screen.id!=="INV-067";
