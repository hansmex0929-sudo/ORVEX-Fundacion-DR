...
import { ActivityPanel,ApprovalQueue,DataTable,FilterBar,FormShell,KpiGrid,PageHeader,Planner,StateGallery,StatusBadge } from "@/components/ui";
...
export function ScreenRenderer({screen}:{screen:ScreenDefinition}){
  ...
  const isForm=screen.kind==="form"||screen.kind==="proof";
